    ...
    <div className="space-y-6">
      ...
      <div className="text-sm text-muted-foreground bg-muted p-4 rounded-lg print:hidden">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>Valitse "Sovita sivulle" tai "Fit to page" tulostusasetuksista</li>
          <li>60×80cm kokoon: Tulosta A0-kokoiselle paperille tai useammalle A3-arkille</li>
...
// Separate SVG content component for reuse in both preview and print
...
const GameBoardSVG = ({ tiles, width, height, selectedTile, hoveredTile, onTileClick, onTileHover }: GameBoardSVGProps) => {
  return (
    <>
      ...
      {/* Background */}
      <rect width={width} height={height} fill="#F5E6C8" />
      ...
      {/* Copyright */}
      <text x={width / 2} y={height - 15} textAnchor="middle" fontSize={8} fill="#8B4513">
