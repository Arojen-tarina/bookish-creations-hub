...
export const translations: Record<Language, Record<string, string>> = {
    ...
    'faction.howToPlayHint': 'Joka vuoro käyt läpi 5 vaihetta järjestyksessä. Paina "Seuraava" siirtyäksesi vaiheesta toiseen.',
    ...
    'faction.step3.title': 'Hyökkäys',
    'faction.step3.desc': 'Valitse armeija ja liiku viereiseen alueeseen tai hyökkää vihollisen alueelle.',
    'faction.step4.title': 'Rakenna',
    'faction.step4.desc': 'Rakenna leiri, markkina tai linnoitus omille alueillesi.',
    'faction.step5.title': 'Lopeta vuoro',
    'faction.step5.desc': 'AI-vastustajat tekevät omat siirtonsa. Uusi vuoro alkaa.',
    'faction.goal.military.title': '{{provinces}} provinssia tai kaikki pääkaupungit',
    'faction.goal.military.sub': 'Sotilasvoitto',
    'faction.goal.economic.title': '{{gold}} kultaa + Silkkitie ({{streak}} vuoroa)',
    'faction.goal.economic.sub': 'Talousvoitto',
    'faction.goal.tech.title': '{{tech}} teknologiakorttia',
    'faction.goal.tech.sub': 'Teknologiavoitto',
    'faction.goal.diplomatic.title': '{{influence}} vaikutusvaltaa tai {{allies}}+ liittolaista',
    'faction.goal.diplomatic.sub': 'Diplomatiavoitto',
    'faction.goal.cultural.title': '{{prestige}} arvovaltaa (Ihmeet)',
    ...
    'faction.name.mongol': 'Mongolien valtakunta',
    'faction.name.song': 'Song-dynastia',
    'faction.name.rus': 'Venäjän ruhtinaskunnat',
    'faction.name.khwarezm': 'Khwarezmin valtakunta',
    'faction.ruler.mongol': 'Tšingis-kaani',
    'faction.ruler.song': 'Keisari Ningzong',
    'faction.ruler.rus': 'Suuriruhtinas',
    'faction.ruler.khwarezm': 'Šaahi Muhammad II',
    'faction.flavor.mongol': 'Aroilta nousee myrsky: Temüjin on yhdistänyt heimot, ja maailma vavahtaa kavioiden alla.',
    'faction.flavor.song': 'Silkin ja ruudin sivistys, jonka aarteet ja oppineisuus houkuttelevat susia porteille.',
    'faction.flavor.rus': 'Metsien ja jokien ruhtinaat vartioivat pyhiä kaupunkejaan pohjoisen kalvakassa valossa.',
    'faction.flavor.khwarezm': 'Karavaanireittien valtias, jonka minareetit hohtavat Samarkandin yllä — ylväs mutta altis.',
    ...
    'phase.attack.label': 'Hyökkäys',
    'phase.attack.hint': 'Valitse armeija ja liiku tai hyökkää viereisiin alueisiin.',
    ...
    'achv.title': 'Saavutukset',
    'achv.level': 'Taso',
    'achv.points': 'pistettä',
    'achv.hiddenName': '???',
    'achv.hiddenDesc': 'Piilotettu saavutus — avaa se nähdäksesi tiedot.',
    'achv.category.tutorial': 'Opastus',
    'achv.category.early_game': 'Alkupeli',
    'achv.category.mid_game': 'Keskipeli',
    'achv.category.end_game': 'Loppupeli',
    'achv.category.hidden': 'Piilotetut',
    'achv.category.skill': 'Taito',
    'achv.category.exploration': 'Tutkimusmatkailu',
    'achv.category.collection': 'Kokoelmat',
    'achv.category.challenge': 'Haasteet',
    'achv.category.historical': 'Historialliset',
  ...
  en: {
    ...
    'faction.howToPlayHint': 'Each turn you go through 5 phases in order. Press "Next" to move from one phase to another.',
    ...
    'faction.step3.title': 'Attack',
    'faction.step3.desc': 'Select an army to move to a neighboring province or attack an enemy province.',
    'faction.step4.title': 'Build',
    'faction.step4.desc': 'Build a camp, market, or fortress in your own provinces.',
    'faction.step5.title': 'End turn',
    'faction.step5.desc': 'AI opponents make their moves. A new turn begins.',
    'faction.goal.military.title': '{{provinces}} provinces or all capitals',
    'faction.goal.military.sub': 'Military victory',
    'faction.goal.economic.title': '{{gold}} gold + Silk Road ({{streak}} turns)',
    'faction.goal.economic.sub': 'Economic victory',
    'faction.goal.tech.title': '{{tech}} technology cards',
    'faction.goal.tech.sub': 'Technology victory',
    'faction.goal.diplomatic.title': '{{influence}} influence or {{allies}}+ allies',
    'faction.goal.diplomatic.sub': 'Diplomatic victory',
    'faction.goal.cultural.title': '{{prestige}} prestige (Wonders)',
    ...
    'faction.name.mongol': 'Mongol Empire',
    'faction.name.song': 'Song Dynasty',
    'faction.name.rus': 'Rus Principalities',
    'faction.name.khwarezm': 'Khwarezmian Empire',
    'faction.ruler.mongol': 'Genghis Khan',
    'faction.ruler.song': 'Emperor Ningzong',
    'faction.ruler.rus': 'Grand Prince',
    'faction.ruler.khwarezm': 'Shah Muhammad II',
    'faction.flavor.mongol': 'A storm rises from the steppe: Temujin has united the tribes, and the world trembles beneath the hooves.',
    'faction.flavor.song': 'A civilization of silk and gunpowder, whose treasures and scholarship draw wolves to its gates.',
    'faction.flavor.rus': 'Princes of forests and rivers guard their sacred cities in the pale northern light.',
    'faction.flavor.khwarezm': 'Master of the caravan routes, whose minarets shine above Samarkand, proud yet exposed.',
    ...
    'phase.attack.hint': 'Select an army to move or attack adjacent provinces.',
    ...
    'achv.points': 'points',
    'achv.hiddenName': '???',
    'achv.hiddenDesc': 'Hidden achievement — unlock it to see the details.',
    'achv.category.tutorial': 'Tutorial',
    'achv.category.early_game': 'Early Game',
    'achv.category.mid_game': 'Mid Game',
    'achv.category.end_game': 'End Game',
    'achv.category.hidden': 'Hidden',
    'achv.category.skill': 'Skill-Based',
    'achv.category.exploration': 'Exploration',
    'achv.category.collection': 'Collection',
    'achv.category.challenge': 'Challenge',
    'achv.category.historical': 'Historical',
