...
export const strategyCards: GameCard[] = [
  ...
  { id: 'str-051', type: 'strategy', name: 'Genghis Khanin Henki', description: 'Suuren valloittajan inspiraatio', effect: 'Kaikki yksiköt +2 hyökkäys ja puolustusvoimaa tällä vuorolla', rarity: 'legendary' },
...
export const resourceCards: GameCard[] = [
  ...
  { id: 'res-038', type: 'resource', name: 'Mestariaseseppä', description: 'Legendaarista käsityötä', effect: 'Pysyvä +1 hyökkäysbonus', rarity: 'legendary' },
  { id: 'res-039', type: 'resource', name: 'Pajagilda', description: '1 käsityöläinen per vuoro', effect: 'Jatkuva tuotanto', rarity: 'legendary' },
  ...
  { id: 'res-049', type: 'resource', name: 'Jalokivet', description: 'Timantteja ja rubiineja', effect: '+10 kultaa', rarity: 'rare' },
  { id: 'res-050', type: 'resource', name: 'Khaanin Tiara', description: 'Kuninkaalliset jalokivet', effect: '+20 kultaa', rarity: 'legendary' },
];
