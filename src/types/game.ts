...
export const EVENT_CARDS: EventCard[] = [
  ...
  },
  {
    ...
    description: 'Vauraus leviää Silkkitietä pitkin',
    effect: 'Kaikki Silkkitien provinssit tuottavat +3 kultaa',
    duration: 2,
    affectsAll: true,
  },
  {
...
export const FACTIONS: Record<FactionId, Faction> = {
  ...
  persia: {
    ...
    color: '#3b82f6',
    bonus: 'Vaurauden bonus',
    bonusDescription: 'Silkkitien provinssit tuottavat +2 kultaa ja +1 käsityöläisiä',
  },
  russia: {
    id: 'russia',
