    ...
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src={comicArt} alt="Sarjakuvataide" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="container mx-auto px-4 z-10">
          <div className="max-w-3xl">
            ...
            <p
              className="text-xl md:text-2xl text-muted-foreground mb-8 font-body leading-relaxed animate-fade-in"
              style={{ animationDelay: "0.2s" }}
            >
              Eeppinen trilogia mongolisotureista — kunniasta, rakkaudesta ja arojen loputtomasta horisontista.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <ComicPanel className="overflow-hidden p-0">
              <img src={comicArt} alt="Sarjakuvapaneeli mongolisotureista" className="w-full h-auto" />
            </ComicPanel>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-12">Projektin Osat</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link to="/lautapeli" className="group">
              <ComicPanel variant="primary" className="h-full transition-transform group-hover:-translate-y-1">
                ...
                <p className="text-muted-foreground text-sm">Strateginen lautapeli romaanin maailmaan perustuen.</p>
              </ComicPanel>
            </Link>
            ...
            <Link to="/liiketoiminta" className="group">
              <ComicPanel className="h-full transition-transform group-hover:-translate-y-1">
                ...
                <p className="text-muted-foreground text-sm">Liiketoimintasuunnitelma ja kaupallinen strategia.</p>
              </ComicPanel>
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-12">Keskeiset Teemat</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm">Soturien tie ja kestävyys vaikeuksien edessä.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm">Myyttiset eläimet ja henkimaailman viisaus.</p>
            </div>
          </div>
        </div>
      </section>
